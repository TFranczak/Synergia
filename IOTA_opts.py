...
# simulation options
opts.add("macro_particles", 1000, "Particles in PIC sim")
...
# output options
opts.add("particles_tracked", 10, "Number of particle for track diagnostic tool")
...
opts.add("custom_flags", "Mark", "Append a custom flag to output name. Empty string for no flag")
