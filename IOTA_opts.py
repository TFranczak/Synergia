...
opts.add("turns", 2000, "Amount of turns around synchrotron")
...
# output options
opts.add("particles_tracked", 0, "Number of particle for track diagnostic tool")
...
opts.add("output_flags", "Mark", "Append a custom flag to output name. Empty string for no flag")
